...
TOKEN = '7466672545:AAHV5hgha__9YWsSaidawoUY3XDrPrfUsvM'
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/srimanddos/12*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@TG_SRIMAN DM ME*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@TG_SRIMAN*", parse_mode='Markdown')
    else:
